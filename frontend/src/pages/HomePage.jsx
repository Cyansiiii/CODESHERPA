  ...
  const tweetWall = [
    {
      ...
      name: "Rahul Sharma",
      verified: true,
      handle: "@rahul_dev_tcs",
      chips: ["TCS", "Senior Dev"],
      glow: "hover:shadow-[inset_0_0_30px_rgba(59,130,246,0.08)]",
    ...
    {
      avatar: "PP",
      avatarClass: "from-violet-700 to-purple-500",
      name: "Priya Patel",
      verified: false,
      handle: "@priya_techlead",
      chips: ["Infosys", "Tech Lead"],
      glow: "hover:shadow-[inset_0_0_30px_rgba(139,92,246,0.08)]",
    ...
    },
    {
      ...
      name: "Manish Singh",
      verified: true,
      handle: "@manish_paytm_eng",
      chips: ["Paytm", "Lead Eng"],
      glow: "hover:shadow-[inset_0_0_30px_rgba(34,197,94,0.08)]",
      ...
      tag: "Code Quality: 9.2/10",
      tagClass: "border-green-400/25 text-green-300 bg-green-500/10",
      comments: "62",
      reposts: "189",
      likes: "743",
      time: "Mar 3, 2026",
    },
    {
      ...
      name: "Amit Kumar",
      verified: false,
      handle: "@amit_freelance_dev",
      chips: ["Freelance"],
      glow: "hover:shadow-[inset_0_0_30px_rgba(249,115,22,0.08)]",
    ...
    {
      avatar: "ST",
      avatarClass: "from-pink-700 to-pink-500",
      name: "Sonal Trivedi",
      verified: true,
      handle: "@sonal_ola_em",
      chips: ["Ola", "Eng Manager"],
      glow: "hover:shadow-[inset_0_0_30px_rgba(236,72,153,0.08)]",
      body: "Review cycle dropped from 2 days to under 4 hours after GitHub webhook integration with CodeSherpa.",
      tag: "75% faster reviews",
      tagClass: "border-purple-400/25 text-purple-300 bg-purple-500/10",
      comments: "104",
      reposts: "387",
      likes: "3.2K",
    ...
    {
      avatar: "NC",
      avatarClass: "from-cyan-700 to-cyan-500",
      name: "Neha Chaudhary",
      verified: false,
      handle: "@neha_sec_eng",
      chips: ["Juspay", "Security Eng"],
      glow: "hover:shadow-[inset_0_0_30px_rgba(6,182,212,0.08)]",
    ...
    <div className="min-h-screen bg-[#030712] text-slate-200 overflow-hidden relative selection:bg-indigo-500/30">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 pt-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          >
            Review code, learn faster, and ship with confidence using our
            multi-agent AI platform built specifically for developers.
          </motion.p>
          ...
          >
            {[
              ...
              <div
                key={i}
                className="flex items-center gap-2 px-4 py-2 rounded-full glass-panel text-sm text-slate-400"
              >
          ...
          <div className="w-full grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <p className="text-base md:text-lg leading-relaxed text-slate-300/90 max-w-lg mb-10">
                Just paste your code. CODESHERPA analyzes structure, logic,
                complexity, and security in one go - with actionable feedback.
              </p>
                ...
                <div className="p-5 md:p-6 space-y-5 bg-gradient-to-b from-[#0f1125]/75 to-[#080913]/85">
                  <div className="rounded-xl border border-white/10 bg-black/30 p-4">
                    <pre className="typing-code text-sm leading-6 overflow-x-auto">
                      <code>
                        ...
                        <span className="text-blue-300">process_user_data</span>
                        <span className="text-slate-300">(</span>
                        <span className="text-orange-300">user_id</span>
                        <span className="text-slate-300">):</span>
                        {"\n"}
                        {"    "}query ={" "}
                        ...
                        <span className="text-blue-300">db.execute</span>
                  ...
                  <div className="rounded-xl border border-amber-300/20 bg-amber-500/10 p-4">
                    ...
                    <div className="space-y-2.5 text-sm leading-relaxed">
                      ...
                      <p className="text-slate-300">
                        Validate user_id type &amp; range
                      </p>
                    </div>
                  </div>

                  <div className="rounded-xl border border-emerald-300/20 bg-emerald-500/10 p-4">
                    <p className="text-xs tracking-wide uppercase font-semibold text-emerald-200 mb-2">
                      Suggested fix
                    </p>
                    <pre className="text-sm leading-6 overflow-x-auto">
                      <code>
                        ...
                        <span className="text-blue-300">process_user_data</span>
                        <span className="text-slate-300">(</span>
                        <span className="text-orange-300">user_id: int</span>
                        <span className="text-slate-300">):</span>
                        {"\n"}
                        {"    "}query ={" "}
                        <span className="text-emerald-300">
      ...
      <section className="relative py-14 overflow-hidden border-y border-white/[0.05] bg-white/[0.01]">
        ...
        <LogoLoop
          logos={[
            {
              node: <Brain className="w-10 h-10 text-blue-400" />,
              title: "Orchestrator",
            },
            {
              node: <Code2 className="w-10 h-10 text-purple-400" />,
              title: "Coder",
            },
            {
              node: <Shield className="w-10 h-10 text-emerald-400" />,
              title: "Security",
            },
            {
              node: <Bug className="w-10 h-10 text-rose-400" />,
              title: "Debugger",
            },
            {
              node: <Database className="w-10 h-10 text-amber-400" />,
              title: "SQL Expert",
            },
            {
              node: <Cloud className="w-10 h-10 text-cyan-400" />,
              title: "DevOps",
            },
            {
              node: <Bot className="w-10 h-10 text-pink-400" />,
              title: "QA Bot",
            },
            {
              node: <Terminal className="w-10 h-10 text-orange-400" />,
              title: "Terminal",
            },
            {
              node: <Zap className="w-10 h-10 text-yellow-400" />,
              title: "Performance",
            },
            {
              node: <Globe className="w-10 h-10 text-indigo-400" />,
              title: "Localization",
            },
          ]}
          speed={60}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="glass-card glass-hover-card p-6 rounded-2xl text-center group"
              >
        ...
        <div className="max-w-[1280px] mx-auto">
          ...
          >
            ...
            <p className="text-base md:text-lg text-slate-400 max-w-2xl mx-auto font-light leading-relaxed">
              Paste your code once. Watch five specialized agents work in
              perfect harmony.
            </p>
          </motion.div>
                ...
                >
                  ...
                  <div
                    ...
                    onMouseLeave={(e) => {
                      ...
                      const orb =
                        e.currentTarget.querySelector(".workflow-glow-orb");
                      if (orb) {
                        orb.style.left = "50%";
                        orb.style.top = "50%";
                      }
                  ...
                  >
                    ...
                    <div className="workflow-card-inner relative z-10 flex flex-col h-full">
                      <p
                        className={`text-[11px] uppercase tracking-[0.14em] font-bold mb-1 ${step.labelColor}`}
                      >
                        {step.label}
                      </p>
                      ...
                      <p className="text-[13px] leading-6 text-slate-500 mb-4">
                        {step.desc}
                      </p>
                      ...
                      <div className="flex flex-wrap justify-center gap-1.5 mb-4">
                        {step.tags.map((tag) => (
                          <span
                            key={tag}
                            className={`px-2.5 py-1 rounded-full border text-[10px] font-semibold tracking-wide uppercase ${step.tagClass}`}
                          >
                            {tag}
                          </span>
                        ))}
                      ...
                      <div className="pt-3 border-t border-white/10 mt-auto">
                        <p className={`text-2xl font-black ${step.labelColor}`}>
                          {step.stat}
                        </p>
                        <p className="text-[11px] tracking-wide uppercase text-slate-600">
                          {step.statLabel}
                        </p>
                      </div>
                    </div>
              ...
              <div className="flex flex-wrap gap-8">
                {[
                  ...
                  <div key={item.l} className="text-center">
                    <p className="text-2xl md:text-3xl font-black text-transparent bg-clip-text bg-gradient-to-br from-white to-blue-200">
                      {item.n}
                    </p>
                    <p className="text-[11px] tracking-[0.12em] uppercase text-slate-600">
                      {item.l}
                    </p>
                  </div>
                ))}
            ...
            {[
              {
                ...
                title: "Connect",
                description:
                  "Link your GitHub repository or paste code directly into our secure sandbox.",
              ...
              },
              {
                ...
                title: "Analyze",
                description:
                  "Our multi-agent system reviews heavily for bugs, security risks, and patterns.",
              ...
              },
              {
                ...
                title: "Optimize",
                description:
                  "Receive detailed, actionable feedback in your preferred language.",
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-10 h-10 rounded-full bg-gradient-to-br ${tweet.avatarClass} grid place-items-center text-xs font-extrabold`}
                    >
                      {tweet.avatar}
                    </div>
                    <div>
                ...
                {tweet.chips?.length > 0 && (
                  <div className="flex flex-wrap gap-2 mb-3">
                    {tweet.chips.map((chip) => (
                      <span
                        key={chip}
                        className="px-2 py-0.5 rounded-md text-[10px] font-semibold tracking-wide uppercase bg-white/5 border border-white/10 text-slate-400"
                      >
                        {chip}
                      </span>
                    ))}
                ...
                <p className="text-[0.92rem] leading-7 text-slate-200 mb-3">
                  {tweet.body}
                </p>
                ...
                {tweet.tag && (
                  <span
                    className={`inline-block px-2.5 py-1 rounded-full text-[10px] font-semibold tracking-wider uppercase border mb-3 ${tweet.tagClass}`}
                  >
                    {tweet.tag}
                  </span>
                )}
                ...
                <div className="pt-3 border-t border-white/10 flex items-center gap-4 text-slate-500 text-xs">
                  ...
                  <span className="ml-auto text-[10px] tracking-wide text-slate-600">
                    {tweet.time}
                  </span>
                </div>
              </motion.article>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-base md:text-lg text-slate-300/85 mb-11 max-w-xl mx-auto font-light leading-relaxed">
                Join thousands of developers using CodeSherpa to ship better
                code, faster.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <button
                  onClick={() => navigate("/chat")}
                  className="group relative px-8 py-4 rounded-xl font-bold text-base text-white bg-white/10 border border-white/20 backdrop-blur-md overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:bg-white/30 hover:shadow-[0_0_60px_-10px_rgba(255,255,255,0.7)] hover:scale-110 hover:rotate-1"
                >
                  <span className="relative z-10 flex items-center gap-3">
                    Get Started Free
                    <span className="w-6 h-6 rounded-full bg-white/20 grid place-items-center text-sm group-hover:translate-x-2 group-hover:bg-white/40 group-hover:rotate-12 transition-all duration-500">
                      🚀
                    </span>
                  </span>

                  {/* Animated background gradient */}
                  <div className="absolute inset-0 bg-gradient-to-r from-cyan-400/30 via-blue-500/30 to-purple-600/30 opacity-0 group-hover:opacity-100 transition-all duration-500 transform group-hover:scale-110" />

                  {/* Ripple effect */}
                  <div className="absolute inset-0 rounded-xl bg-white/30 scale-0 group-hover:scale-150 group-hover:opacity-0 transition-all duration-800" />

                  {/* Shimmer effect */}
                  <div className="absolute inset-0 -top-2 -bottom-2 bg-gradient-to-r from-transparent via-white/30 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1200" />

                  {/* Glow effect */}
                  <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-400 to-purple-500 blur-2xl opacity-0 group-hover:opacity-40 transition-opacity duration-500 -z-10" />

                  {/* Particle effect */}
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <div className="absolute top-1 left-4 w-1 h-1 bg-yellow-400 rounded-full animate-ping animation-delay-200" />
                    <div className="absolute top-3 right-6 w-1 h-1 bg-pink-400 rounded-full animate-ping animation-delay-400" />
                    <div className="absolute bottom-2 left-8 w-1 h-1 bg-cyan-400 rounded-full animate-ping" />
                  </div>
                </button>
