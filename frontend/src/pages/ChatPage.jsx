...
const API_BASE =
  import.meta.env.VITE_API_URL || "https://codesherpa-i47c.onrender.com";
const WS_BASE =
...
const ChatPage = () => {
      ...
      return (
        ...
        >
          <motion.div
            ...
            className="rounded-2xl border border-cyan-500/25 bg-gradient-to-r from-cyan-500/10 to-blue-500/5 p-4 sm:p-5"
          >
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <h3 className="mt-1 text-xl font-semibold text-white">
                  Engineering productivity is on track
                </h3>
              </div>
          ...
          >
            {stats.map((stat) => (
              <motion.div
                key={stat.label}
                whileHover={panelCardHover}
                className="glass-hover-card rounded-2xl border border-white/10 bg-slate-900/60 p-4"
              >
          ...
          >
            <motion.div
              whileHover={panelCardHover}
              className="glass-hover-card rounded-2xl border border-white/10 bg-slate-900/60 p-5"
            >
              ...
              <p className="mt-3 text-sm text-slate-400">
                72% sprint completion achieved this week.
              </p>
            </motion.div>
            <motion.div
              whileHover={panelCardHover}
            ...
            >
              ...
              <p className="mt-3 text-sm text-slate-400">
                Enable auto triage for security alerts to reduce review lag by
                ~18%.
              </p>
              <motion.button
    ...
    if (selectedSection === "Agents") {
      const agents = [
        {
          name: "Review Monk",
          status: "Active",
          role: "Code review and security checks",
          load: 68,
        },
        {
          name: "Codebase Sherpa",
          status: "Active",
          role: "Code explanation and guidance",
          load: 54,
        },
        {
          name: "Orchestrator",
      ...
      return (
        ...
        >
          <motion.div
            variants={panelItemVariants}
            className="rounded-2xl border border-purple-500/25 bg-gradient-to-r from-purple-500/10 to-fuchsia-500/5 p-4 sm:p-5"
          >
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <h3 className="mt-1 text-xl font-semibold text-white">
                  Multi-agent pipeline running live
                </h3>
              </div>
    ...
    if (selectedSection === "Projects") {
      ...
      return (
        ...
        >
          <motion.div
            variants={panelItemVariants}
            className="rounded-2xl border border-blue-500/25 bg-gradient-to-r from-blue-500/10 to-cyan-500/5 p-4 sm:p-5"
          >
            <h3 className="text-xl font-semibold text-white">
              Project Workspace
            </h3>
            <p className="mt-2 text-sm text-slate-300">
              Track delivery progress, code health, and pending reviews in one
              place.
            </p>
          </motion.div>
              ...
              >
                ...
                <div className="mt-3 flex flex-wrap items-center justify-between gap-2">
                  ...
                  <motion.button
                    whileHover={secondaryButtonHover}
                    whileTap={{ scale: 0.98 }}
                    className="inline-flex items-center gap-1 rounded-lg border border-white/15 px-3 py-1.5 text-xs text-slate-200 hover:bg-white/10"
                  >
    ...
    if (selectedSection === "Settings") {
      ...
      return (
        ...
        >
          <motion.div
            variants={panelItemVariants}
            className="rounded-2xl border border-emerald-500/25 bg-gradient-to-r from-emerald-500/10 to-cyan-500/5 p-4 sm:p-5"
          >
            <h3 className="text-xl font-semibold text-white">
              Workspace Settings
            </h3>
            <p className="mt-2 text-sm text-slate-300">
              Tune assistant behavior, model routing, and notification
              preferences.
            </p>
          </motion.div>
          ...
          >
            ...
            <motion.div
              whileHover={panelCardHover}
              className="glass-hover-card rounded-2xl border border-white/10 bg-slate-900/60 p-4 flex flex-col justify-between"
            >
              <div className="flex items-center justify-between">
                ...
                <motion.button
                  ...
                  whileHover={secondaryButtonHover}
                  whileTap={{ scale: 0.98 }}
                  className="rounded-lg border border-white/15 px-2 py-1 text-[11px] text-slate-200 hover:bg-white/10"
                >
            ...
            >
              ...
              <p className="mt-2 text-base font-medium text-white">
                {autoReviewEnabled ? "Enabled" : "Disabled"}
              </p>
            </motion.div>
            ...
            <motion.div
              whileHover={panelCardHover}
              className="glass-hover-card rounded-2xl border border-white/10 bg-slate-900/60 p-4 md:col-span-2"
            >
              <div className="flex items-center gap-2 justify-between">
                <div className="flex items-center gap-2">
                  <ShieldAlert className="h-4 w-4 text-cyan-300" />
                  <p className="text-sm text-slate-300">
                    Override API Provider Key
                  </p>
                </div>
              </div>
                  ...
                  onClick={() => {
                    ...
                    fetch(`${API_BASE}/api/models/key`, {
                      ...
                      .then((data) =>
                        alert(
                          data.status === "success"
                            ? "API Key saved securely to active model backend."
          ...
          >
            <div className="flex flex-wrap items-center justify-between gap-2">
              <p className="text-sm text-slate-300">
                Run quick diagnostics for latency, websocket health, and agent
                sync.
              </p>
              <motion.button
                onClick={() => {
                ...
                whileHover={actionButtonHover}
                whileTap={{ scale: 0.98 }}
                className="inline-flex items-center gap-2 rounded-lg bg-cyan-500 px-3 py-2 text-xs font-semibold text-slate-900 hover:bg-cyan-400"
              >
  ...
  return (
    <div className="min-h-screen text-white">
      ...
      <div className="fixed inset-0 top-[73px] pt-0 lg:left-72 px-3 sm:px-4">
          ...
          <AnimatePresence mode="wait">
            {selectedSection === "Chat" ? (
              <motion.div
                ...
                className="flex flex-col h-full rounded-3xl border border-white/10 bg-slate-950/40 backdrop-blur-md shadow-[0_20px_80px_rgba(0,0,0,0.35)]"
              >
                <div className="flex h-full flex-1 min-h-0 flex-col overflow-hidden">
                  ...
                  >
                    <AnimatePresence>
                      {messages.map((msg, index) => (
                        ...
                        >
                          <div
                            className={`max-w-[88%] sm:max-w-[80%] ${msg.sender === "user" ? "order-2" : "order-1"}`}
                          >
                            <motion.div
                              whileHover={{
                                y: -1,
                                ...
                                boxShadow:
                                  msg.sender === "user"
                                    ? "0 10px 20px rgba(6,182,212,0.18)"
                            ...
                            >
                              <div
                                className={`prose max-w-none ${msg.sender === "user" ? "prose-slate" : "prose-invert"}`}
                              >
                                <ReactMarkdown
                                  components={{
                                    code({
                              ...
                              <div
                                className={`mt-2 text-right text-xs ${msg.sender === "user" ? "text-slate-800/70" : "text-slate-400"}`}
                              >
                                {msg.timestamp}
                              </div>
                            </motion.div>
                  ...
                  <div className="shrink-0 border-t border-white/10 bg-slate-900/70 p-3 sm:p-4">
                    <input
                      ref={fileInputRef}
                      type="file"
                    ...
                    <div className="flex gap-2 sm:gap-3">
                      ...
                      <motion.button
                        ...
                        onClick={sendMessage}
                        disabled={
                          (!input.trim() && !attachedFile) || !isConnected
                        }
              ...
              <motion.div
                ...
                exit={{ opacity: 0, y: -12, scale: 0.99 }}
                transition={{ duration: 0.28, ease: "easeOut" }}
                className="glass-hover-card flex flex-col h-full rounded-3xl border border-white/10 bg-slate-950/40 p-4 backdrop-blur-md sm:p-6 overflow-y-auto"
                data-lenis-prevent
              >
                <div className="glass-hover-card mb-4 rounded-2xl border border-white/10 bg-slate-900/50 px-4 py-3 shrink-0">
                  <p className="text-xs uppercase tracking-[0.14em] text-cyan-300">
                    {selectedSection}
                  </p>
                  <p className="mt-1 text-sm text-slate-300">
                    {sectionDescription[selectedSection]}
                  </p>
                </div>
