  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled ? "bg-slate-950/65 backdrop-blur-xl" : "bg-transparent"
      }`}
    >
        ...
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <TextRoll
              ...
              textClassName="gradient-text-white"
            >
              CODESHERPA
            </TextRoll>
          </button>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button
              ...
              className="group relative px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full font-semibold text-sm text-white overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/60 hover:scale-110 hover:-translate-y-1 hover:rotate-1"
            >
              ...
              {/* Glow effect */}
              <div className="absolute inset-0 rounded-full bg-gradient-to-r from-blue-400 to-purple-500 blur-xl opacity-0 group-hover:opacity-30 transition-opacity duration-500 -z-10" />
            </button>
          </div>
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <button
                ...
                className="group relative px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg font-semibold text-white overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/60 hover:scale-110 hover:-translate-y-1 hover:rotate-1"
              >
                <span className="relative z-10 flex items-center gap-2">
                  <span>Get Started</span>
                  <span className="w-0 group-hover:w-4 transition-all duration-300 overflow-hidden">
